...
$conf['settings']['default.timezone'] = 'Europe/Warsaw';              // look up here http://php.net/manual/en/timezones.php
$conf['settings']['allow.self.registration'] = 'true';         	// if users can register themselves
$conf['settings']['admin.email'] = 'cezary.butler+booked@gmail.com';         // email address of admin user
